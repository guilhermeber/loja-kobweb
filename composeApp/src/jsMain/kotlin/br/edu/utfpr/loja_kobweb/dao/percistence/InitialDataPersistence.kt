package br.edu.utfpr.loja_kobweb.dao.percistence
...
object InitialDataPersistence {
    fun initialProducts(startId: Int): List<Product> {
        var nextId = startId
        return listOf(
    ...
    fun initialUsers(startId: Int): List<User> {
        var nextId = startId
        return listOf(
            User(
                id = nextId++,
